...
#define iOS8Later NO//([UIDevice currentDevice].systemVersion.floatValue >= 8.0f)
...
- (void)tz_imagePickerController:(TZImagePickerController *)picker didFinishPickingPhotos:(NSArray<UIImage *> *)photos sourceAssets:(NSArray *)assets;
- (void)tz_imagePickerController:(TZImagePickerController *)picker didFinishPickingPhotos:(NSArray<UIImage *> *)photos sourceAssets:(NSArray *)assets infos:(NSArray<NSDictionary *> *)infos;
- (void)tz_imagePickerControllerDidCancel:(TZImagePickerController *)picker;
// If user picking a video, this callback will be called.
// If system version > iOS8,asset is kind of PHAsset class, else is ALAsset class.
// 如果用户选择了一个视频，下面的handle会被执行
// 如果系统版本大于iOS8，asset是PHAsset类的对象，否则是ALAsset类的对象
- (void)tz_imagePickerController:(TZImagePickerController *)picker didFinishPickingVideo:(UIImage *)coverImage sourceAssets:(id)asset;


/*!
 *  @param photos [TZAssetModel]
 */
- (void)tz_imagePickerController:(TZImagePickerController *)picker didFinishPickingAssets:(NSArray *)assets;

//- (void)tz_imagePickerController:(TZImagePickerController *)picker didFinishPickingThumbs:(NSArray<UIImage *> *)thumbs assets:(NSArray *)assets;
