...
@interface TZPhotoPreviewController ()<UICollectionViewDataSource,UICollectionViewDelegate, UICollectionViewDelegateFlowLayout,UIScrollViewDelegate> {
    BOOL _willRotate;
...
- (void)configCustomNaviBar {
    ...
    _backButton = [[UIButton alloc] initWithFrame:CGRectMake(0, 10, 44, 44)];
...
//    _toolBar.backgroundColor = [UIColor colorWithRed:0 / 255.0f green:187 / 255.0f blue:221 / 255.0f alpha:1.0];
    ...
    if (imagePickerVc.allowPickingOriginalPhoto) {
        ...
        _originalPhotoButton.frame = CGRectMake(0, 0, 70, 44);
        _originalPhotoButton.imageEdgeInsets = UIEdgeInsetsMake(0, -5, 0, 0);
//        _originalPhotoButton.backgroundColor = [UIColor redColor];
        ...
        _originalPhotoLable.activityIndicatorViewStyle = UIActivityIndicatorViewStyleWhite;
...
- (void)viewWillLayoutSubviews{
    ...
    _numberImageView.frame = CGRectMake(self.view.tz_width - 42 - 26, 9, 26, 26);
    ...
    _selectButton.frame = CGRectMake(self.view.tz_width - 42, 10, 42, 42);
    _okButton.frame     = CGRectMake(self.view.tz_width - 68, 0, 68, 44);
    if (_willRotate) {
        ...
        [_collectionView setContentOffset:CGPointMake((self.view.tz_width) * _currentIndex, 0) animated:NO];
        _willRotate = NO;
    }
}
...
- (void)select:(UIButton *)selectButton {
    ...
    if (!selectButton.isSelected) {
        ...
        if (self.selectedPhotoArr.count >= imagePickerVc.maxImagesCount) {
            ...
            {
                TZAssetModel *lastModel = (TZAssetModel *)[self.selectedPhotoArr firstObject];
                lastModel.isSelected = NO;
                [self.selectedPhotoArr removeObject:lastModel];
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout*)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath{
    return CGSizeMake(self.view.tz_width, self.view.tz_height);
}
